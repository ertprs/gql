...
export const INSERIR_CLIENTE = gql`
  mutation inserirCliente($clienteInput: ClienteInput!, $enderecoInput: EnderecoInput) {
...
export const LANCAR_PAGAMENTO = gql`
  mutation lancarPagamento($idAtendimento: String!, $pagamentoInput: PagamentoInput!) {
    lancarPagamento(idAtendimento: $idAtendimento, pagamentoInput: $pagamentoInput) {
      id
      valorPedido
      valorEntrega
      valorTotal
